...
var CategoryPage = /** @class */ (function () {
    ...
    CategoryPage.prototype.DatabaseInfo = function () {
        var _this = this;
        this.db.list('/Categories/category/').valueChanges().subscribe(function (data) {
            console.log(data);
            _this.infos = data;
    ...
    CategoryPage.prototype.itemSelected = function (infos) {
